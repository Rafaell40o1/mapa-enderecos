...
Geocodificação automática: pontos aproximados são destacados; registros sem correspondência suficiente permanecem na lista. Novas coordenadas exigem município correspondente e tipo de resultado de endereço, rua ou estabelecimento, além de pontuação mínima. Coordenadas anteriormente obtidas para endereços iguais foram reutilizadas.
